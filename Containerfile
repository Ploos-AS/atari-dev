...
RUN git clone "$MINT_TOOLCHAIN_REPO" /src/mint \
 ...
 && sed -i -E 's/CC="gcc -arch \$\(ARCH\)"/CC="gcc"/g; s/CXX="g\+\+ -arch \$\(ARCH\)"/CXX="g++"/g; s/ -Wno-error=null-pointer-arithmetic//g; s#/share/automake-1\.\*/config\.\*#/usr/share/automake-1.*/config.*#g' Makefile.* \
